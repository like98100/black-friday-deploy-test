...
public class QProductCouponEpin extends EntityPathBase<ProductCouponEpin> {
    ...
    private static final long serialVersionUID = -1063020237L;
    ...
    public final EnumPath<com.flab.blackfriday.modules.product.coupon.dto.CouponUseStatus> useStatus = createEnum("useStatus", com.flab.blackfriday.modules.product.coupon.dto.CouponUseStatus.class);

    public final EnumPath<com.flab.blackfriday.modules.product.coupon.dto.CouponUseType> useType = createEnum("useType", com.flab.blackfriday.modules.product.coupon.dto.CouponUseType.class);
